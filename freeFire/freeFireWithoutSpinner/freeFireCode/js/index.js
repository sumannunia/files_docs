...
// Create new wheel object specifying the parameters at creation time.
            var theWheel = new Winwheel({
                ...
                [
                   {'image' : 'jane.png',  'text' : 'Skin 1'},
                   {'image' : 'tom.png',   'text' : 'Skin 2'},
                   {'image' : 'mary.png',  'text' : 'Skin 3'},
                   {'image' : 'alex.png',  'text' : 'Skin 4'},
                   {'image' : 'sarah.png', 'text' : 'Skin 5'},
                   {'image' : 'bruce.png', 'text' : 'Skin 6'},
                   {'image' : 'rose.png',  'text' : 'Skin 7'},
                   {'image' : 'steve.png', 'text' : 'Skin 8'}
                ],
            ...
            function alertPrize(indicatedSegment)
            {
                ...
                window.location = './order-page.html?skin=' + indicatedSegment.text.replace(" ", '_');
            }