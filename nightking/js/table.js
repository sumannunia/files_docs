...
class RdataTB {
    ...
    Control() {
        ...
        span1.innerHTML = `
        <table id="C" border="0" style="width:100%;margin-bottom:12px;" class="table-responsive">
        <tr>
          <td style="width:100%;">
             <select id="my-select" class="custom-select shadow-none" style="float:left;width:99px!important;margin-right:10px;">
