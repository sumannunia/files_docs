...
<head>
    ...
    <title>Sherley Sethiya Videos | Hojai.net</title>
    <!-- Font-->
    ...
    <div class="container d-none">
        ...
        <section>
                ...
                <div class="thetopNav">
                    ...
                    <div class="theSearchInput">
                        <form class="d-flex position-relative" id="theSearchForm">
                            <input class="form-control mr-sm-2" type="text" placeholder="Search your video" aria-label="Search" id="theSearchInput" >
            ...
            <article class="container thedata-section">
                <h3 class="thetitle-heading-man">Vidya Vox Videos</h3>
