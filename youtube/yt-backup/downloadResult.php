                ...
                <div class="thetopNav">
                    ...
                    <div class="theSearchInput">
                        <form class="d-flex position-relative" id="theSearchForm">
                            <input class="form-control mr-sm-2" type="text" placeholder="Search" aria-label="Search" id="theSearchInput" disabled>
                            <button class="btn theSearch-btn" type="submit" disabled><i class="fas fa-search" ></i></button>
                        </form>
                    </div>
